...
ggplot(sunapee, aes(x=year, y=ice_off_doy)) +
  geom_point() +
  geom_line() +
  labs(title='Lake Sunapee Ice Off Day Over Time', x='Year', y='Ice Off Day')
```
...
The residuals do not meet the assumptions of linear regression. They have a center around zero, but are skewed to the left. 
